            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@ihmmarineservices.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Maritime Way, Harbor District</p>
                  <p className="text-gray-600">Singapore, 00000</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-8 rounded-lg border border-gray-100 shadow-sm">
            ...
            <form className="space-y-6">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand-teal focus:border-brand-teal" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                <input type="email" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand-teal focus:border-brand-teal" placeholder="john@company.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Message</label>
                <textarea rows="4" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand-teal focus:border-brand-teal" placeholder="How can we help you?"></textarea>
              </div>
              <button type="button" className="w-full bg-marine-900 text-white font-bold py-3 rounded-md hover:bg-brand-teal transition">
                Send Message
              </button>
            </form>
          </div>
