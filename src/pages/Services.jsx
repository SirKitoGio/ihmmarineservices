            ...
            {coreServices.map((service, index) => {
              const CoreServiceCard = () => {
                ...
                return (
                  <div
                    ref={ref}
                    className={`flex flex-col md:flex-row gap-12 items-center transition-all duration-700 ${isReversed ? 'md:flex-row-reverse' : ''
                      } ${isVisible
              ...
              return <CoreServiceCard key={index} />;
            })}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {additionalServices.map((service, idx) => {
              const AdditionalServiceCard = () => {
                const { ref, isVisible } = useScrollAnimation(0.1, idx * 100);

                return (
                  <div
                    ref={ref}
                    className={`bg-gray-50 rounded-xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-700 ${isVisible
              ...
              return <AdditionalServiceCard key={service.id} />;
            })}
          </div>
        </div>
